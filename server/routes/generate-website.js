...
router.post('/generate-website', isLoggedIn, async (req, res) => {
    ...
    // console.log('websiteContact: ', websiteContact);
    ...
    // generatedWebsite = generatedWebsite.replace('<!-- sub title -->', websiteSubTitle);
    // generatedWebsite = generatedWebsite.replace('<!-- school summary -->', websiteSchoolSummary);
    // generatedWebsite = generatedWebsite.replace('<!-- school details -->', websiteSchoolDetails);
    // generatedWebsite = generatedWebsite.replace('<!-- experiences -->', websiteExperiences);
    // generatedWebsite = generatedWebsite.replace('<!-- experience1 -->', websiteExperience1);
    // generatedWebsite = generatedWebsite.replace('<!-- experience2 -->', websiteExperience2);
    // generatedWebsite = generatedWebsite.replace('<!-- experience3 -->', websiteExperience3);
    // generatedWebsite = generatedWebsite.replace('<!-- contact -->', websiteContact);
    ...
    if (personalWebsiteExists) {
        ...
        //if it does not exist, then create a new item in the PersonalWebsite collection
